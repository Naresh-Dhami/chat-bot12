...
const ChatWindow: React.FC<ChatWindowProps> = ({
  ...
  return (
    <div className="flex flex-col h-full bg-gradient-to-br from-red-500/5 to-red-600/5">
      {/* Header */}
        ...
        {conversation.messages.length === 0 ? (
          <div className="flex items-center justify-center h-full">
            <div className="text-center">
              ...
              <p className="text-gray-500">Send a message to begin chatting with ChatBot</p>
            </div>
          </div>
        ) : (
          <>
